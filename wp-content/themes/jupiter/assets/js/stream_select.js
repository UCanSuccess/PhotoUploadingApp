var stream_select = function (data) {
    var initTable = function (data) {
    	var ajax_url="";
	    console.log("init");
		console.log(data);

        var table = jQuery('#stream_table');
        var ta =  table.DataTable({
            "sAjaxSource": ajax_url = "http://localhost/wp-content/themes/jupiter/assets/js/stream-table.php?group="+data,
            "language": {
                "aria": {
